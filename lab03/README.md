...
| **Performance (Cart)** | `/cart/add` latency| p95 < 50 ms | 20 VU тогтмол ачаалал, 1 мин |
| **Performance (Report)** | `/report` latency | p95 < 450 ms | 20 VU тогтмол ачаалал, 1 мин |
...
Сценариос SLO руу шилжиж, улмаар код дээр хатуу threshold босго тогтоох явцад системийн бодит хязгаар болон хүлээгдэж буй гүйцэтгэлийг хооронд нь зөрүүлэхгүй байх нь энэхүү лабораторийн хамгийн чухал сорилт байлаа. Тухайлбал, /report endpoint-ийн хугацааны санамсаргүй хүлээлт нь стандарт босго тогтооход нарийн дүн шинжилгээ хийх шаардлагыг бий болгосон юм. Туршилтын явцад хийсэн мини Chaos туршилт нь манай availability болон reliability сценарийн хэмжүүрийг бодитоор баталж өгсөн бөгөөд сервер гэнэт унахад Error Budget хэрхэн агшин зуур шатаж, хяналтын систем (thresholds) алдааг шуурхай илрүүлж буйг харууллаа. Мөн k6 тест дээр гарсан non-zero exit code нь орчин үеийн CI/CD pipeline дээр бүтээгдэхүүний чанар болон бэлэн байдлыг автоматаар шалгаж, алдаатай хувилбарыг цаг тухайд нь зогсооход ямар амин чухал үүрэгтэй болохыг бүрэн ойлгож ухаарлаа. Энэхүү ажлаар дамжуularа бид системийн найдвартай байдлыг код түвшинд хэрхэн автоматжуулан хянах арга зүйд суралцсан нь цаашид бодит төслүүдэд ашиглахад үнэтэй туршлага боллоо.